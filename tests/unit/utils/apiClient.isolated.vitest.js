 ...
 * 
 * This file tests the API client with the circuit breaker manually disabled
 */
...
// Create a modified version of RobustAPIClient for testing
class TestApiClient extends RobustAPIClient {
  constructor(options = {}) {
    super(options);
    
    // Replace circuit breaker with a mock
    this.circuitBreaker = {
      isOpen: () => false,
      recordSuccess: () => {},
      recordFailure: () => {}
...
describe('Isolated API Client Tests', () => {
  let client;
  let mockAxios;
