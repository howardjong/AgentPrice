...
async function applyOptimizations() {
  ...
  await safelyRunOptimizationStep('Saving Optimization Settings', async () => {
    const optimizationSettings = {
      ...
      memoryLeakDetection: memoryLeakDetector.isEnabled(),
      ...
      documentFingerprinting: { 
        enabled: true,
        cacheSize: documentFingerprinter.getCacheSize(),
        similarityThreshold: documentFingerprinter.options.similarityThreshold
      },
